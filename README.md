...
| Компонент          | RPS (x12) | Пиковый RPS (х3) (x12) | CPU (ядер) (x12) | RAM (GB) (x12) | Назначение и обоснование                                                                                    |
|--------------------|-----------|------------------------|------------------|----------------|-------------------------------------------------------------------------------------------------------------|
| User Service       |     98400 |                 295200 |              300 |            384 | Аутентификация, авторизация, профили пользователей. Высокий RPS из-за проверки сессий на каждом запросе     |
| Search Service     |    152772 |                 458316 |              468 |            768 | Векторный поиск, фильтрация. Требует много CPU для ранжирования и RAM для кэша результатов                  |
...
| RabbitMQ           |    114084 |                 342252 |              348 |           1536 | Очереди нотификации и оплаты через WB кошелек. Большой объем сообщений, требуется много RAM для буферизации |

...
- Нью-Йорк: ~20% от общего RPS
- Вирджиния: ~15% от общего RPS
- Калифорния: ~25% от общего RPS
- Портленд: ~10% от общего RPS
- Техас: ~15% от общего RPS
- Чикаго: ~15% от общего RPS
...
|------------------------------------------|-------------------|----------|
| Apache Kafka                             | Генерация аналитики      | Масштабируемая публикация/подписка на события в реальном времени |
...
| API Gateway (Nginx)                      | Везде  | Маршрутизация запросов по сервисам |
...
| Global Server Load Balancer L4     |    540000 |                1620000 |              324 |            192 | Глобальная балансировка на L3/L4. Меньше CPU чем NGINX                                                      |
...
|--------|------------|----------|-------|------------|----------|
| **PostgreSQL** | 	2x6338/8x32GB/2xNVMe4T/2x25Gb/s |128  |120 |256|32 ядра × 120 = 3840 ядер|
...
| **PostgreSQL**       | m6g.8xlarge  | 50,448.72$             |
